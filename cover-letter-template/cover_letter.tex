...
\phone[mobile]{+852-6467-6899}                   % optional, remove / comment the line if not wanted
%\phone[fixed]{+2~(345)~678~901}                    % optional, remove / comment the line if not wanted
%\phone[fax]{+3~(456)~789~012}                      % optional, remove / comment the line if not wanted
\email{chanyatfu0616@gmail.com}                               % optional, remove / comment the line if not wanted
\homepage{github.com/chanyatfu}                         % optional, remove / comment the line if not wanted
...
%-----       letter       ---------------------------------------------------------
% recipient data
\recipient{Recipient}{Human Resources, \companyname}
\date{\today}
